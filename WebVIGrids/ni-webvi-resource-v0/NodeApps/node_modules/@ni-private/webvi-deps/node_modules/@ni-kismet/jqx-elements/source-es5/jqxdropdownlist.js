...
*/
JQX('jqx-drop-down-list', function (_JQX$ContentElement) {
    babelHelpers.inherits(DropDownList, _JQX$ContentElement);

    function DropDownList() {
        babelHelpers.classCallCheck(this, DropDownList);
        return babelHelpers.possibleConstructorReturn(this, (DropDownList.__proto__ || Object.getPrototypeOf(DropDownList)).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(DropDownList, [{
        ...
        */
        value: function propertyChangedHandler(propertyName, oldValue, newValue) {
            babelHelpers.get(DropDownList.prototype.__proto__ || Object.getPrototypeOf(DropDownList.prototype), 'propertyChangedHandler', this).call(this, propertyName, oldValue, newValue);
        ...
        */
        ...
        value: function attached() {
            ...
            babelHelpers.get(DropDownList.prototype.__proto__ || Object.getPrototypeOf(DropDownList.prototype), 'attached', this).call(this);
        ...
        value: function detached() {
            ...
            babelHelpers.get(DropDownList.prototype.__proto__ || Object.getPrototypeOf(DropDownList.prototype), 'detached', this).call(this);
        ...
        */
        ...
        value: function cloneNode() {
            ...
            var clone = HTMLElement.prototype.cloneNode.apply(that, Array.prototype.slice.call(arguments, 0, 1));
        ...
        */
        ...
        value: function open() {
            var that = this,
                getFirstFocusableItem = function getFirstFocusableItem() {
        ...
        */
        ...
        value: function ready() {
            babelHelpers.get(DropDownList.prototype.__proto__ || Object.getPrototypeOf(DropDownList.prototype), 'ready', this).call(this);
        ...
        */
        ...
        key: '_resizeBarMoveHandler',
        value: function _resizeBarMoveHandler(event) {
        ...
        value: function _createToken() {
            ...
            var selectedIndexes = that.selectedIndexes,
            ...
            for (var i = 0; i < selectedIndexes.length; i++) {
                ...
                if (items[selectedIndex]) {
                    fragment.appendChild(that._applyTokenTemplate(items[selectedIndex][that.inputMember], that.selectionDisplayMode !== 'tokens' && selectedIndex === lastSelectedIndex ? '' : icon));
                }
            }
        ...
        */
        ...
        key: '_applyTokenTemplate',
        value: function _applyTokenTemplate(label, icon) {
            var that = this;
            var element = document.createElement('span'),
                token = function token() {
                return '<span class=\'jqx-drop-down-list-selection-label\'>' + label + '</span><span class=\'jqx-drop-down-list-unselect-button\'>' + icon + '</span>';
            };

            element.classList.add('jqx-token');

            if (that._tokenTemplate) {
                var content = document.importNode(that._tokenTemplate.content, true);
        ...
        value: function _buttonsDownHandler(event) {
            ...
            if (that.hasRippleAnimation) {
                if (!that.$.buttonsContainer || that.dropDownOpenMode === 'dropDownButton') {
                    ...
                    var target = that.$.buttonsContainer;
        ...
        */
        ...
        value: function _documentDownHandler(event) {
            ...
            if (that.$.listBox) {
                var listItem = target.closest('jqx-list-item');
            ...
            var computedStyle = that.$.dropDownContainer.getBoundingClientRect();
        ...
        value: function _documentMoveHandler(event) {
            ...
            function verticalResize() {
                ...
                if (direction === 'bottom') {
                    ...
                    that._resizeDetails.height = Math.min(doc.clientHeight - computedStyle.top - 6, Math.max(0, that._resizeDetails.height + size));

                    that._resizeDetails.y = Math.max(computedStyle.top + doc.scrollTop - that._resizeDetails.offsetY, Math.min(doc.clientHeight + doc.scrollTop - that._resizeDetails.offsetY * 1.5, event.pageY));
                } else {
                    ...
                    if (that.dropDownAppendTo && that.dropDownAppendTo.length > 0) {
                        var margin = Math.abs(parseFloat(getComputedStyle(that.$.dropDownContainer).getPropertyValue('margin-bottom'))) || 0;

                        that.$.dropDownContainer.style.top = that.dropDownAppendTo && that.dropDownAppendTo.length > 0 ? margin + size + 'px' : '';
                    }

                    var minYCondition = dropDownStyle.top + doc.scrollTop + that._resizeDetails.offsetYtop;

                    that._resizeDetails.y = Math.max(that._resizeDetails.offsetYtop, Math.min(minYCondition, Math.max(minYCondition - that._dropDownSize.maxHeight, event.pageY)));
                }
            ...
            function horizontalResize() {
                ...
                //6 is the margin of document.body, we don't want scrollbars to be shown
                that._resizeDetails.width = Math.min(doc.clientWidth - computedStyle.left - 6, Math.max(0, that._resizeDetails.width + size));

                that.$.dropDownContainer.style.width = that._resizeDetails.width + 'px';

                that._resizeDetails.x = Math.max(computedStyle.left + doc.scrollLeft - that._resizeDetails.offsetXR, Math.min(doc.clientWidth + doc.scrollLeft - that._resizeDetails.offsetXR * 1.5, event.pageX));
            }
        ...
        */
        ...
        value: function _documentUpHandler(event) {
            ...
            var isActionButtonPressed = target.closest('.jqx-action-button');
        ...
        */
        ...
        key: '_buttonsFocusHandler',
        value: function _buttonsFocusHandler(event) {
            var that = this;
        ...
        */
        ...
        value: function _keyDownHandler(event) {
            ...
            if (that.$.listBox && target === that.$.listBox.$.filterInput || activeElement !== that && activeElement !== that.$.dropDownButton && activeElement !== that.$.actionButton) {
                return;
            }
        ...
        */
        ...
        value: function _listBoxChangeHandler(event) {
            ...
            if (that.autoComplete === 'list' && event.detail) {
                var lastSelectedItem = that.$.listBox._items[event.detail.index];
        ...
        */
        ...
        key: '_listBoxKeyDownHandler',
        value: function _listBoxKeyDownHandler(event) {
            var that = this;
        ...
        */
        ...
        value: function _setDropDownSize() {
            ...
            if (that.dropDownWidth) {
                if (that.dropDownWidth !== 'auto') {
                    ...
                    if (that.$.listBox) {
                        var horizontalOffset = 2 + 2 * parseInt(window.getComputedStyle(that.$.listBox.$.itemsContainer).getPropertyValue('--jqx-list-item-horizontal-offset'));
            ...
            if (that.dropDownHeight && that.dropDownHeight !== 'auto') {
                ...
                if (that.$.listBox && (that._dropDownSize.height === 'auto' || that.dropDownHeight === 'auto')) {
                    ...
                    var verticalOffset = 2 * parseInt(window.getComputedStyle(that.$.listBox.$.itemsContainer).getPropertyValue('--jqx-list-item-vertical-offset'));

                    if (isNaN(verticalOffset)) {
                        verticalOffset = 6;
                    }

                    var dropDownHeight = verticalOffset;

                    if (that.$.listBox.items.length > 0) {
                        that.$.listBox.items.map(function (item) {
                            return dropDownHeight += item.height || item.offsetHeight;
                        });
                    }
        ...
        value: function _styleChangedHandler(event) {
            ...
            if (that.dropDownAppendTo && that.dropDownAppendTo.length > 0) {
                var styleProperties = event.detail.styleProperties,
                    fontProperties = ['font-size', 'font-family', 'font-style', 'font-weight'];

                for (var s = 0; s < fontProperties.length; s++) {
        ...
        */
        ...
        key: 'styleUrls',
        get: function get() {
            return ['jqx.dropdownlist.css', 'jqx.dropdown.css'];
        }
    }, {
        key: 'requires',
        get: function get() {
