...
*/
JQX('jqx-docking-layout', function (_JQX$ContentElement) {
    babelHelpers.inherits(DockingLayout, _JQX$ContentElement);

    function DockingLayout() {
        babelHelpers.classCallCheck(this, DockingLayout);
        return babelHelpers.possibleConstructorReturn(this, (DockingLayout.__proto__ || Object.getPrototypeOf(DockingLayout)).apply(this, arguments));
    }

    babelHelpers.createClass(DockingLayout, [{
        key: '_moveHandler',
        ...
        */
        ...
        value: function propertyChangedHandler(propertyName, oldValue, newValue) {
            ...
            switch (propertyName) {
                ...
                case 'resizeStep':
                    {
                        var allSplitters = that.getElementsByTagName('jqx-splitter');
                ...
                case 'hideSplitterBars':
                    ...
                    break;
                default:
                    babelHelpers.get(DockingLayout.prototype.__proto__ || Object.getPrototypeOf(DockingLayout.prototype), 'propertyChangedHandler', this).call(this, propertyName, oldValue, newValue);
                    break;
            }
        }
        ...
        */
        ...
        value: function ready() {
            babelHelpers.get(DockingLayout.prototype.__proto__ || Object.getPrototypeOf(DockingLayout.prototype), 'ready', this).call(this);

            var that = this;

            //AutoLoadState
            if (that.autoLoadState) {
                var previousState = that.loadState();
        ...
        */
        ...
        key: 'autoHideBottom',
        value: function autoHideBottom(item) {
        ...
        key: 'autoHideLeft',
        value: function autoHideLeft(item) {
        ...
        key: 'autoHideRight',
        value: function autoHideRight(item) {
        ...
        key: 'autoHideTop',
        value: function autoHideTop(item) {
        ...
        key: 'undock',
        value: function undock(tabsWindow) {
            var that = this;
            ...
            var splitterItem = tabsWindow.closest('jqx-splitter-item');

            if (!splitterItem) {
                return;
            }

            var splitterItemRect = splitterItem.getBoundingClientRect();
            ...
            if (tabsWindow instanceof JQX.TabsWindow) {
                ...
                var splitterParent = splitterItem.closest('jqx-splitter');
                ...
                var parentTabsWindow = tabsWindow.closest('jqx-tabs-window');
                var newTabsWindow = void 0;
            ...
            var itemIndex = that._items.indexOf(tabsWindow);
            ...
            if (that._items.filter(function (item) {
                return item.opened;
            }).length === 0 && !that.$.placeholderItem.parentElement) {
        ...
        key: 'insertBefore',
        value: function insertBefore(newNode, node, topLevelInsert) {
            var that = this;
            ...
            if (node) {
                ...
                parentSplitter.insertBefore(newNode, parentSplitter._items.filter(function (item) {
        ...
        key: 'insertBeforeItem',
        value: function insertBeforeItem(index, item) {
        ...
        key: 'insertAfterItem',
        value: function insertAfterItem(index, item) {
        ...
        key: 'insertIntoLeft',
        value: function insertIntoLeft(index, item) {
        ...
        key: 'insertIntoRight',
        value: function insertIntoRight(index, item) {
        ...
        key: 'insertIntoTop',
        value: function insertIntoTop(index, item) {
        ...
        key: 'insertIntoBottom',
        value: function insertIntoBottom(index, item) {
        ...
        key: 'insertLayoutTop',
        value: function insertLayoutTop(item) {
        ...
        key: 'insertLayoutBottom',
        value: function insertLayoutBottom(item) {
        ...
        key: 'insertLayoutLeft',
        value: function insertLayoutLeft(item) {
        ...
        key: 'insertLayoutRight',
        value: function insertLayoutRight(item) {
        ...
        key: 'insertOutsideTargetGroupTop',
        value: function insertOutsideTargetGroupTop(index, item) {
        ...
        */
        ...
        key: 'insertOutsideTargetGroupBottom',
        value: function insertOutsideTargetGroupBottom(index, item) {
        ...
        */
        ...
        key: 'insertOutsideTargetGroupLeft',
        value: function insertOutsideTargetGroupLeft(index, item) {
        ...
        */
        ...
        key: 'insertOutsideTargetGroupRight',
        value: function insertOutsideTargetGroupRight(index, item) {
        ...
        */
        ...
        key: 'getAutoHideItems',
        value: function getAutoHideItems(orientation) {
            var that = this;
            ...
            function getItems(splitter) {
                ...
                for (var i = 0; i < splitter._items.length; i++) {
        ...
        */
         ...
         */
        value: function getItemGroupElement(item) {
            var that = this;
        ...
        */
        ...
        key: 'getState',
        value: function getState(noInstances) {
            var that = this,
                autoHideItems = that.getAutoHideItems(),
                undockedItems = that.undockedItems,
                structure = [];

            for (var i = 0; i < autoHideItems.length; i++) {
                structure.push(that._createTabsWindowStructure(autoHideItems[i], noInstances));
            }

            for (var _i = 0; _i < undockedItems.length; _i++) {
                structure.push(that._createTabsWindowStructure(undockedItems[_i], noInstances));
            }
        ...
        */
        ...
        key: 'getClosestSplitterBars',
        value: function getClosestSplitterBars(item) {
            var that = this;
            ...
            if (!(item instanceof JQX.TabsWindow) || !that._items.find(function (i) {
                return i === item;
            })) {
                return;
            }

            var closestSplitter = item.closest('jqx-splitter');
        ...
        key: 'loadState',
        value: function loadState(previousState) {
            var that = this;
        ...
        */
        ...
        value: function removeChild(node) {
            ...
            var splitterItem = node.closest('jqx-splitter-item');

            if (!splitterItem) {
                return;
            }

            var splitter = splitterItem.closest('jqx-splitter');
        ...
        */
        ...
        value: function update(item, settings) {
            ...
            if (!settings || (typeof settings === 'undefined' ? 'undefined' : babelHelpers.typeof(settings)) !== 'object') {
                return;
            }
            ...
            var parentSplitterItem = item.closest('jqx-splitter-item');
        ...
        */
        ...
        key: '_autoHide',
        value: function _autoHide(tabsWindow, position) {
            var that = this;
            ...
            var splitterItem = tabsWindow.closest('jqx-splitter-item'),
                tabsWindowSize = void 0;
            var splitterContainer = tabsWindow.closest('jqx-splitter') || that.$.itemsContainer,
            ...
            var autoHideName = 'auto-hide-' + position;
            ...
            var tabsWindowIndex = that._items.indexOf(tabsWindow);
            ...
            autoHideSplitter.bars.map(function (bar) {
                return bar.hide();
            });

            that._setAutoHidePaddings();

            var tabsWindowItems = tabsWindow.items;

            if (tabsWindowItems) {
                for (var i = 0; i < tabsWindowItems.length; i++) {
        ...
        key: '_getAutoHidePositionDetails',
        value: function _getAutoHidePositionDetails(position, tabsWindow, splitterItem) {
            var that = this,
            ...
            switch (position) {
                ...
                default:
                    if (splitterContainer.orientation === 'vertical') {
                        ...
                        var autoHiddenItems = autoHideSplitter.items.filter(function (item) {
                            return item.className.indexOf('auto-hide-') > -1;
                        });
                        ...
                        var _autoHiddenItems = autoHideSplitter.items.filter(function (item) {
                            return item.className.indexOf('auto-hide-') > -1;
                        });

                        if (_autoHiddenItems.length === 1 && that._items.length === 1) {
                            position = _autoHiddenItems[0].$.hasClass('auto-hide-bottom') ? 'bottom' : 'top';
                        } else {
        ...
        value: function _handleAutoHideWindow(details) {
            var that = this,
            ...
            var tabsWindow = details.tabsWindow,
            ...
            if (autoHiddenItem) {
                var tabItems = [].slice.call(tabsWindow.isCompleted ? tabsWindow.items : tabsWindow.children),
                ...
                for (var c = 0; c < splitterItem.classList.length; c++) {
                ...
                if (JQX.Utilities.Core.Browser.Safari && (position === 'left' || position === 'right')) {
                    var tabStrip = tabsWindow.querySelector('.jqx-tab-strip');

                    tabsWindow.size = tabStrip.offsetWidth;
                } else {
                    if (JQX.Utilities.Core.Browser.Firefox && (position === 'top' || position === 'bottom')) {
                        var _tabStrip = tabsWindow.querySelector('.jqx-tab-strip');

                        tabsWindow.size = _tabStrip.offsetHeight;
                    }
        ...
        */
        ...
        key: '_autoHideWindowCloseHandler',
        value: function _autoHideWindowCloseHandler() {
            var that = this,
        ...
        key: '_autoHideWindowResizeEndHandler',
        value: function _autoHideWindowResizeEndHandler(event) {
            var autoHideWindow = event.target,
        ...
        value: function _cancelDragOperation(noEndDrag) {
            var that = this;
        ...
        */
        ...
        key: '_createTabsWindowFromObject',
        value: function _createTabsWindowFromObject(settings, retrieveContent) {
            var tabsWindow = document.createElement('jqx-tabs-window');
            var item = void 0,
        ...
        key: '_createItemsFromArray',
        value: function _createItemsFromArray(source, retrieveContenent) {
            var that = this;
            var layoutConfig = source;
            var layoutLength = layoutConfig.length;
            ...
            var undockedItems = that.undockedItems;

            for (var i = 0; i < undockedItems.length; i++) {
            ...
            for (var _i2 = 0; _i2 < layoutConfig.length; _i2++) {
                item = that._createLayoutItem(layoutConfig[_i2], retrieveContenent);
        ...
        value: function _createLayoutItem(settings, retrieveContent) {
            if (!settings) {
                return;
            }
        ...
        key: '_createLayoutStructure',
        value: function _createLayoutStructure(splitter, noInstance) {
            var that = this,
                structure = [];
            var items = splitter._items,
                item = void 0,
                splitterItem = void 0;
            var firstItemChild = items[0].$.content.children[0];
        ...
        key: '_createTabsWindowStructure',
        value: function _createTabsWindowStructure(tabsWindow, noInstance) {
            function createTabItemStructure(tabItem) {
                var tabItemStructure = {};
            ...
            if (tabsWindow.items) {
                ...
                for (var i = 0; i < tabsWindow.items.length; i++) {
        ...
        */
        ...
        key: '_containerTabStripResizeHandler',
        value: function _containerTabStripResizeHandler(event) {
            var that = this,
        ...
        */
        ...
        key: '_dock',
        value: function _dock(tabsWindow, position) {
            var that = this;
            ...
            if (tabsWindow instanceof JQX.TabItem) {
                var tabItemDockingDetails = that._handleTabItemDocking(tabsWindow);

                tabsWindow = tabItemDockingDetails.tabsWindow;
                newTabsWindow = tabItemDockingDetails.newTabsWindow;
            } else if ((typeof tabsWindow === 'undefined' ? 'undefined' : babelHelpers.typeof(tabsWindow)) === 'object' && !(tabsWindow instanceof HTMLElement)) {
        ...
        key: '_handleTabItemDocking',
        value: function _handleTabItemDocking(tabsWindow) {
            var that = this,
                parentTabsWindow = tabsWindow.closest('jqx-tabs-window');
            var newTabsWindow = void 0;

            if (parentTabsWindow) {
                var autoHideWindow = that.$.autoHideWindow;
        ...
        */
        ...
        key: '_dockEventHandler',
        value: function _dockEventHandler(event) {
            var that = this;
            var tabsWindow = event.target;
        ...
        value: function _documentDownHandler(event) {
            ...
            if (that._dragDetails || target.maximized || target.minimized || !JQX.Utilities.Core.isMobile && event.which !== 1 || target._dragDetails && target._dragDetails.type === 'resize' && target._dragDetails.started) {
                return;
            }
            ...
            that._items.map(function (item) {
                return item.removeAttribute('ontop');
            });
        ...
        */
        ...
        value: function _documentMoveHandler(event) {
            ...
            if (that._dragDetails.windowFeedback === that.$.autoHideWindow) {
                var selectedTabsWindowRect = that._dragDetails.selectedTabsWindow.getBoundingClientRect();
                var newTabsWindow = void 0;
            ...
            if (!that._dragDetails.windowFeedback.classList.contains('jqx-tabs-window-feedback')) {
                ...
                if (that._dragDetails.selectedItem) {
                    var closestSplitter = that._dragDetails.selectedItem.closest('jqx-splitter');
            ...
            if (that._dragDetails.windowFeedback.hasAttribute('tabs-window-dragged') || that._dragDetails.selectedTabsWindow === that.$.autoHideWindow || that._dragDetails._parentInfo && typeof that._dragDetails._parentInfo.position === 'string') {
            ...
            var tabHeader = that._dragDetails.hoveredTabsWindow ? target.closest('.jqx-tabs-header-section') : undefined;

            if (tabHeader) {
                that._dragDetails.hoveredTabArea = tabHeader;
            } else {
                that._dragDetails.hoveredTabArea = that._dragDetails.hoveredTabsWindow && target.closest('.jqx-tabs-content-section') ? that._dragDetails.hoveredTabsWindow.$.tabsElement.$.tabContentSection : that._dragDetails.hoveredTabsWindow;
            }
        ...
        key: '_setDragDetailsOnMove',
        value: function _setDragDetailsOnMove(target) {
            var that = this;
            ...
            if (!that.hasAttribute('dragged')) {
                ...
                var isVerticalScrollable = (document.scrollingElement || document.documentElement).scrollHeight > document.documentElement.clientHeight,
                ...
                var selectedTabsWindow = that._dragDetails.selectedTabsWindow;
                ...
                if (that._dragDetails.windowFeedback.$.hasClass('jqx-tabs-window-feedback') || selectedTabsWindow === that.$.autoHideWindow) {
                    var tabItem = that._dragDetails.selectedTabLabel.tab || that.$.autoHideWindow._tab;
                    var feedbackWindow = that.$.tabsWindowFeedback;
                    ...
                    var draggedWindow = that._dragDetails.selectedTabsWindow;
                    ...
                    if (draggedWindow === that.$.autoHideWindow) {
                        ...
                        var isAutoHide = draggedWindow.autoHide;
                    ...
                    if (tabItem._autoHideWindowSize) {
                        ...
                        var sizeName = 'offset' + (selectedTabsWindow.tabPosition === 'top' || selectedTabsWindow.tabPosition === 'bottom' ? 'Height' : 'Width');
            ...
            if (that._dragDetails.hoveredItem) {
                var closestLayout = that._dragDetails.hoveredItem.closest('jqx-docking-layout');
            ...
            if (that._dragDetails.hoveredTabsWindow) {
                var _closestLayout = that._dragDetails.hoveredTabsWindow.closest('jqx-docking-layout');

                if (_closestLayout && _closestLayout !== that) {
        ...
        key: '_documentDragStartHandler',
        value: function _documentDragStartHandler(event) {
            var that = this;
        ...
        value: function _documentUpHandler(event) {
            ...
            var isInsideTheLayout = target.closest && target.closest('jqx-docking-layout');

            if (event.ctrlKey) {
                that._snapFeedback._position = isInsideTheLayout = undefined;
            }

            var snapFeedbackPosition = that._snapFeedback ? that._snapFeedback._position : undefined;
            ...
            if (!isInsideTheLayout && !snapFeedbackPosition || isInsideTheLayout && !that._dragDetails.hoveredTabArea && !snapFeedbackPosition) {
                ...
                if (that._dragDetails.hoveredTabArea && that._dragDetails.hoveredTabArea.classList.contains('jqx-tabs-header-section')) {
                    var tabLabelCount = that._dragDetails.hoveredTabsWindow.itemLabels.length;

                    var hoveredTabLabel = target.closest('.jqx-tab-label-container'),
                        addToEnd = void 0;
                    ...
                    if (that._dragDetails.hoveredTabsWindow.autoHide) {
                        var autoHidePosition = that._dragDetails.hoveredTabsWindow.tabPosition;
        ...
        key: '_dropWindowOutsideLayout',
        value: function _dropWindowOutsideLayout(event, snapFeedbackPosition, isInsideTheLayout) {
            var that = this;
            var targetWindow = void 0;
            ...
            if (that._dragDetails.windowFeedback.classList.contains('jqx-tabs-window-feedback')) {
                var tabItem = that._dragDetails.windowFeedback.items[0];
                ...
                var selectedTabItem = that._dragDetails.selectedTabLabel.tab;
                var newWindow = document.createElement('jqx-tabs-window');
                ...
                } else if (!snapFeedbackPosition && !(that._dragDetails.selectedItem instanceof JQX.SplitterItem) && that._dragDetails.selectedTabLabel.$.hasClass('jqx-tab-label-container')) {
                    that._returnItemToOrigin(that._dragDetails.windowFeedback);
                }
        ...
        */
        ...
        value: function _endDrag() {
            ...
            if (windowFeedback.$.tabsElement._tabs.length === 0 && windowFeedback.parentElement && !windowFeedback.$.hasClass('jqx-tabs-window-feedback')) {
            ...
            if (!that._eventAlreadyFired && !that._noStateChangeFiring) {
                ...
                var eventDetail = { item: that._dragDetails.targetWindow };
        ...
        key: '_getTabItemContent',
        value: function _getTabItemContent(tabItem) {
            var content = tabItem.isCompleted ? tabItem.$.content : tabItem,
        ...
        value: function _getHeaderLabelDimensions() {
            ...
            var tabsElement = that._dragDetails.hoveredTabsWindow.$.tabsElement,
                isTabPositionVertical = tabsElement.tabPosition === 'left' || tabsElement.tabPosition === 'right';

            var lastTabItemOffsetLeft = 0,
            ...
            if (that._dragDetails.hoveredTabArea) {
                ...
                if (tabsElement.$.tabStrip.children.length > 0) {
                    var lastTabItem = tabsElement.$.tabStrip.children[tabsElement.$.tabStrip.children.length - 1];
            ...
            var nearTabStripScrollButtonOffsetLeft = 0,
            ...
            var hoveredAreaRect = that._dragDetails.hoveredTabArea.getBoundingClientRect(),
        ...
        */
        ...
        key: '_handleAutoSave',
        value: function _handleAutoSave() {
            var that = this;
        ...
        key: '_handleAutoHiddenSplitterBars',
        value: function _handleAutoHiddenSplitterBars() {
            var that = this,
                autoHiddenItems = that.$.itemsContainer.querySelectorAll('.auto-hide-left,.auto-hide-right, .auto-hide-top, .auto-hide-bottom');

            for (var i = 0; i < autoHiddenItems.length; i++) {
        ...
        key: '_handleItemPositionInserting',
        value: function _handleItemPositionInserting(item, targetItem, position) {
            var that = this;
        ...
        */
        ...
        key: '_handleInsideItemInserting',
        value: function _handleInsideItemInserting(targetItem, item, position) {
            var that = this,
                newItem = document.createElement('jqx-splitter-item'),
                newHostItem = document.createElement('jqx-splitter-item');
            var targetSplitterItem = targetItem.closest('jqx-splitter-item'),
                targetSplitter = targetItem.closest('jqx-splitter'),
                targetItemIndex = that._items.indexOf(targetItem),
                newSplitter = void 0;
            ...
            var newItemMaxSize = targetSplitterItem[newSplitter.orientation === 'horizontal' ? 'offsetHeight' : 'offsetWidth'] / 2;
            ...
            if (item.size) {
                var isInPercentages = typeof item.size === 'string' && item.size.indexOf('%') > -1;
        ...
        value: function _handleLayoutItemInserting(targetItem, item, position) {
            var that = this,
            ...
            if (that.$.itemsContainer.orientation === 'horizontal' && (position === 'right' || position === 'left') || that.$.itemsContainer.orientation === 'vertical' && (position === 'top' || position === 'bottom')) {
                var newSplitterItemWithCurrentItems = void 0,
                    currentItemsContainerOrientation = that.$.itemsContainer.orientation;
                var mainSplitter = that.$.itemsContainer,
                    currentItems = [].slice.call(mainSplitter._items),
                    appendItemsToMainSplitter = function appendItemsToMainSplitter(currentItem, newItem) {
                ...
                currentItems.map(function (item) {
                    return item.size = item[mainSplitter._measurements.size];
                });

                var isLastItem = position === 'right' || position === 'bottom';
                ...
                var newSplitterItemWithCurrentItemsSize = mainSplitter[mainSplitter._measurements.size] - newSplitterItem.size;

                if (currentItems.length > 1) {
                    var currentItemsSplitter = document.createElement('jqx-splitter');
                ...
                var itemToBeInsertedBefore = position.indexOf('left') > -1 || position.indexOf('top') > -1 ? that._items.filter(function (item) {
                    return item.opened;
                })[0] : undefined;
        ...
        */
        ...
        key: '_handleNormalItemInserting',
        value: function _handleNormalItemInserting(targetItem, item, position) {
            var targetSplitterItem = targetItem.closest('jqx-splitter-item');
            var that = this,
                targetSplitter = targetItem.closest('jqx-splitter'),
                newItem = document.createElement('jqx-splitter-item'),
                targetSplitterItemIndex = position === 'right' || position === 'bottom' ? targetSplitter._items.indexOf(targetSplitterItem) + 1 : targetSplitter._items.indexOf(targetSplitterItem);
            var targetItemIndex = that._items.indexOf(targetItem);
        ...
        key: '_handleOutsideItemInserting',
        value: function _handleOutsideItemInserting(targetItem, item, position) {
            var that = this,
                newSplitterItem = document.createElement('jqx-splitter-item');
            var targetSplitter = targetItem.closest('jqx-splitter');
            ...
            if (targetSplitter !== that.$.itemsContainer) {
                var targetSplitterItem = targetSplitter.closest('jqx-splitter-item');
                var newSplitter = document.createElement('jqx-splitter'),
                    newSplitterItemWithCurrentItems = document.createElement('jqx-splitter-item');
                ...
                if (!newSplitterItem.size) {
                    ...
                    var newSize = newSplitterItem.size;
        ...
        value: function _handleLayout() {
            ...
            var initialItems = Array.from(that.$.itemsContainer.children);
            ...
            for (var i = 0; i < initialItems.length; i++) {
                ...
                var splitterItem = document.createElement('jqx-splitter-item');
        ...
        */
        ...
        key: '_handleSnapping',
        value: function _handleSnapping(position) {
            var that = this;
        ...
        value: function _handleAdvancedSnapping() {
            ...
            if (that._snapFeedback && !that._dragDetails.hoveredTabsWindow) {
                ...
                if (!that._dragDetails.hoveredItem) {
                    ...
                    if (that._snapFeedback.outherSnapElement && !that._dragDetails.isInsideTheLayout) {
                        var outherElements = [].slice.call(that.$.container.children);

                        for (var i = 0; i < outherElements.length; i++) {
            ...
            var dropPosition = that._dragDetails.hoveredTabsWindow ? that._dragDetails.hoveredTabsWindow.dropPosition : ['all'];

            if (dropPosition.length === 0) {
                dropPosition = ['all'];
            }

            if (that._dragDetails.hoveredTabsWindow instanceof JQX.TabsWindow && that._dragDetails.hoveredTabArea && that._dragDetails.hoveredTabArea.closest('.jqx-tabs-header-section') && (dropPosition.indexOf('all') > -1 || dropPosition.indexOf('header') > -1)) {
                ...
                var dimensions = that._getHeaderLabelDimensions(),
            ...
            var innerSnapElementParent = that._snapFeedback.innerSnapElement.closest('jqx-splitter-item');
            ...
            if (that._dragDetails.hoveredItem instanceof JQX.SplitterItem) {
                ...
                if (that._dragDetails.hoveredItem.className.indexOf('auto-hide') < 0) {
                    var highlighSections = that._snapFeedback.innerSnapElement.querySelectorAll('.top, .bottom, .left, .right, .center');

                    for (var _i3 = 0; _i3 < highlighSections.length; _i3++) {

                        if (dropPosition.indexOf(highlighSections[_i3].className) > -1 || dropPosition.indexOf('all') === 0) {
                            highlighSections[_i3].setAttribute('show', '');
                        } else {
                            highlighSections[_i3].removeAttribute('show');
                        }
                    }
                ...
                var _outherElements = [].slice.call(that._snapFeedback.outherSnapElement.children),
                    _selectedTabsWindow = that._dragDetails.selectedTabsWindow;
                var position = void 0;

                for (var _i4 = 0; _i4 < _outherElements.length; _i4++) {
                    position = _outherElements[_i4].className.replace('jqx-docking-layout-snap ', '');
                    _outherElements[_i4].classList.remove('jqx-hidden');

                    if (_selectedTabsWindow.dropPosition.indexOf('all') > -1 || _selectedTabsWindow.dropPosition.indexOf(position) > -1) {
                        _outherElements[_i4].setAttribute('show', '');
                    } else {
                        _outherElements[_i4].removeAttribute('show');
                    }

                    that.$.container.appendChild(_outherElements[_i4]);
                }
            }
            ...
            if (that._snapFeedback._position === 'center' && that._items.filter(function (item) {
                return item.opened;
            }).length > 0) {
            ...
            if (that._snapFeedback._position === 'header') {
                ...
                var orientation = that._dragDetails.hoveredTabsWindow.closest('jqx-splitter').orientation;

                if ((that._snapFeedback._position === 'left' || that._snapFeedback._position === 'right') && orientation === 'horizontal' || (that._snapFeedback._position === 'top' || that._snapFeedback._position === 'bottom') && orientation === 'vertical') {
        ...
        key: '_handleSimpleSnapping',
        value: function _handleSimpleSnapping(position) {
            var that = this;
            ...
            for (var i = 0; i < that._snapFeedback.classList.length; i++) {
            ...
            var dropPosition = position.indexOf('layout') === 0 ? that._dragDetails.selectedTabsWindow.dropPosition : that._dragDetails.hoveredTabsWindow.dropPosition;
            ...
            var width = void 0,
                ...
                top = void 0,
                left = void 0,
                hoveredAreaRect = void 0;
            var layoutRect = that.getBoundingClientRect(),
                ...
                case 'layout-right':
                    {
                        ...
                        left = layoutRect.left + window.pageXOffset + (position === 'layout-left' ? paddingLeft : 0) + (leftHiddenItem ? leftHiddenItem.offsetWidth : 0) + (position === 'layout-right' ? that.$.itemsContainer.offsetWidth - width - paddingRight : 0);
                        break;
                    }
                case 'layout-top':
                case 'layout-bottom':
                    ...
                    top = layoutRect.top + window.pageYOffset + (topHiddenItem ? topHiddenItem.offsetHeight : 0) + (position === 'layout-bottom' ? that.$.itemsContainer.offsetHeight - height + paddingTop : paddingTop);
        ...
        **/
        ...
        key: '_handleItemNesting',
        value: function _handleItemNesting() {
            var that = this;
            var targetWindow = that._dragDetails.windowFeedback;
            ...
            if (targetWindow.classList.contains('jqx-tabs-window-feedback')) {
                ...
                var context = targetWindow.context;
        ...
        */
        ...
        key: '_handleWindowOnDrag',
        value: function _handleWindowOnDrag() {
            var that = this;
            ...
            var selectedItem = that._dragDetails.selectedItem,
                selectedTabsWindow = that._dragDetails.selectedTabsWindow,
                ...
                if (!that._dragDetails._parentInfo) {
                    ...
                    if (selectedTabsWindow.closest('jqx-docking-layout') === that) {
                        if (selectedTabsWindow.autoHide) {
                            ...
                            var selectedItemIndex = closestSplitter._items.indexOf(selectedItem),
            ...
            if (closestSplitter) {
                ...
                var autoHidePosition = that.$.autoHideWindow._tabsWindow.tabPosition;
            ...
            var itemIndex = that._items.indexOf(that._dragDetails.windowFeedback);
            ...
            if (selectedItem && selectedItem.parentElement) {
                if (that._items.filter(function (item) {
                    ...
                    that.$.itemsContainer._items[0].className.indexOf('auto-hide') > -1 ? that.$.itemsContainer.insert(1, that.$.placeholderItem) : that.$.itemsContainer.insert(0, that.$.placeholderItem);
                }
        ...
        key: '_setWindowFeedbackSize',
        value: function _setWindowFeedbackSize() {
            var that = this,
                selectedTabsWindow = that._dragDetails.selectedTabsWindow;
        ...
        */
        ...
        key: '_insert',
        value: function _insert(index, item, position) {
            var that = this;
            ...
            if ((typeof item === 'undefined' ? 'undefined' : babelHelpers.typeof(item)) === 'object' && !(item instanceof HTMLElement)) {
                item = that._createTabsWindowFromObject(item);
            } else if (typeof item === 'string') {
                item = document.getElementById(item);
            } else if (item instanceof JQX.TabItem) {
                var parentTabsWindow = item.closest('jqx-tabs-window');
            ...
            if (position && position.indexOf('layout') > -1) {
                var openedItems = that._items.filter(function (item) {
                    return item.opened;
                });
            ...
            var targetItem = that._items[index];

            if (that._items[index] && !that._items[index].opened) {
                targetItem = that._items.filter(function (item) {
                    return item.opened;
                })[0];
            }
            ...
            if (parentSplitterItem) {
                var closestSplitter = parentSplitterItem.closest('jqx-splitter');
        ...
        key: '_itemsContainerCloseHandler',
        value: function _itemsContainerCloseHandler(event) {
            var that = this;

            if (event.target instanceof JQX.Tabs) {
                var targetTabs = event.target;
            ...
            var splitterItem = event.target.closest('jqx-splitter-item'),
        ...
        key: '_itemsContainerAutoHideHandler',
        value: function _itemsContainerAutoHideHandler(event) {
            var that = this,
            ...
            var closestSplitterItem = tabsWindow.closest('jqx-splitter-item');

            if (!closestSplitterItem) {
                return;
            }

            var closestSplitter = tabsWindow.closest('jqx-splitter');

            if (!closestSplitter) {
                return;
            }

            var closestSplitterItems = closestSplitter.items,
        ...
        key: '_itemsContainerMenuHandler',
        value: function _itemsContainerMenuHandler(event) {
            var that = this,
                menu = that.$.menu,
        ...
        key: '_itemsContainerResizeHandler',
        value: function _itemsContainerResizeHandler() {
            var that = this,
        ...
        value: function _keyDownHandler(event) {
            ...
            if (event.key === 'Control') {
                ...
                if (that.snapMode === 'advanced') {
                    for (var el in that._snapFeedback) {
                        if (that._snapFeedback[el] instanceof HTMLElement) {
                            if (el === 'outherSnapElement') {
                                var outherElements = that.$.container.children;
        ...
        */
        ...
        key: '_loadState',
        value: function _loadState(state) {
            var that = this;
        ...
        */
        ...
        key: '_removeAll',
        value: function _removeAll(noPlaceholder) {
            var that = this;
        ...
        value: function _removeUnneccessaryItems(splitterContainer) {
        ...
        */
        ...
        key: '_returnItemToOrigin',
        value: function _returnItemToOrigin(item) {
            var that = this;
            ...
            var parentInfo = that._dragDetails._parentInfo;
        ...
        key: '_setAutoHidePaddings',
        value: function _setAutoHidePaddings() {
            var that = this,
        ...
        key: '_setDockedItemsHeaderButtons',
        value: function _setDockedItemsHeaderButtons(tabsWindow) {
            var headerButtons = tabsWindow.headerButtons,
                reservedButtons = ['close', 'maximize', 'minimize'];

            var dockedItemHeaderButtons = headerButtons.filter(function (buttonName) {
                return reservedButtons.indexOf(buttonName) < 0;
            });
        ...
        key: '_setFloatingItemsHeaderButtons',
        value: function _setFloatingItemsHeaderButtons(tabsWindow) {
            var defaultButtons = ['close', 'autoHide']; // ['dock', 'autoHide']

            tabsWindow._originalTabPosition = tabsWindow.tabPosition;

            var floatingItemButtons = tabsWindow.headerButtons.filter(function (buttonName) {
                return defaultButtons.indexOf(buttonName) < 0;
            });
        ...
        */
        ...
        value: function _setSnappingMarkers(event, tabHeader) {
            var that = this,
                target = JQX.Utilities.Core.isMobile ? document.elementFromPoint(event.pageX - window.pageXOffset, event.pageY - window.pageYOffset) : event.originalEvent.target,
            ...
            if (that.snapMode === 'advanced') {
                ...
                that._dragDetails.hoveredItem = target.closest('.jqx-docking-layout-snap') ? target : that._dragDetails.hoveredItem && that._dragDetails.hoveredItem.getElementsByTagName('jqx-splitter').length > 0 ? undefined : that._dragDetails.hoveredItem;
            ...
            if (!that._dragDetails.hoveredTabsWindow || that._dragDetails.windowFeedback !== that.$.tabsWindowFeedback && that._dragDetails.hoveredTabsWindow === that._dragDetails.selectedTabsWindow) {
                that._dragDetails.hoveredItem = target.closest('.jqx-docking-layout-snap') ? target : that._dragDetails.hoveredItem && that._dragDetails.hoveredItem.getElementsByTagName('jqx-splitter').length > 0 ? undefined : that._dragDetails.hoveredItem;
                that._handleSnapping();
                return;
            }

            var hoveredTabOffset = {};

            if (that._dragDetails.hoveredItem) {
                var hoveredItemRect = that._dragDetails.hoveredItem.getBoundingClientRect(),
            ...
            if (that._dragDetails.hoveredTabArea === tabHeader) {
                ...
                if (left < that.$.itemsContainer.offsetWidth * 0.05 && left < that._dragDetails.hoveredItem.offsetWidth * 0.15) {
                    ...
                    var orientation = that._dragDetails.hoveredItem.closest('jqx-splitter').orientation;
                    ...
                    } else if (top < hoveredTabOffset.top + that._dragDetails.hoveredTabArea.offsetTop + that._dragDetails.hoveredTabArea.offsetHeight * 0.5 + that._dragDetails.hoveredTabsWindow.$.headerSection.offsetHeight) {
        ...
        key: '_setSplitterBarVisibility',
        value: function _setSplitterBarVisibility() {
            var that = this,
                splitterBars = that.$.itemsContainer.getElementsByTagName('jqx-splitter-bar');

            for (var i = 0; i < splitterBars.length; i++) {
        ...
        key: '_validateWindowPosition',
        value: function _validateWindowPosition(targetWindow) {
            ...
            requestAnimationFrame(function () {
                return targetWindow.$.removeClass('no-transition');
            });
        }
    }, {
        key: 'autoHideItems',
        ...
        get: function get() {
            ...
            if (that.isReady) {
                return that._items.filter(function (item) {
                    return item.opened;
                }).concat(that.getAutoHideItems());
            }
        }
        ...
        */
        ...
        get: function get() {
            ...
            var tabsWindows = document.getElementsByTagName('jqx-tabs-window');
            var undockedWindows = [];

            for (var i = 0; i < tabsWindows.length; i++) {
