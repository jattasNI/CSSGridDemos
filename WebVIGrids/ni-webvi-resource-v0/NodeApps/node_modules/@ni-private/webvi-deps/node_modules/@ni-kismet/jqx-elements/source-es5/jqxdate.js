...
JQX.Utilities.Assign('TimeSpan', function () {
    function TimeSpan() {
        babelHelpers.classCallCheck(this, TimeSpan);
        ...
        if (arguments.length === 1) {
            ...
            var _days = arguments[0],
                _hours = arguments[1],
                _minutes = arguments[2],
                _seconds = arguments[3],
                _milliseconds = arguments[4],
                _totalMilliSeconds = (_days * 3600 * 24 + _hours * 3600 + _minutes * 60 + _seconds) * 1000 + _milliseconds;

            that._ticks = _totalMilliSeconds * that.ticksPerMillisecond;
        }
    }

    babelHelpers.createClass(TimeSpan, [{
        key: 'ticks',
        ...
        key: 'timeToMS',
        value: function timeToMS(hour, minute, second, milliseconds) {
        ...
        key: 'interval',
        value: function interval(value, scale) {
            var tmp = value * scale,
...
JQX.Utilities.Assign('DateTime', function () {
    function DateTime() {
        babelHelpers.classCallCheck(this, DateTime);

        function getUTCDate(ISOString) {
            var parseResult = that.regexISOString.exec(ISOString);

            UTCDate = new JQX.Utilities.DateTime(parseFloat(parseResult[1]), parseFloat(parseResult[2]), parseFloat(parseResult[3]), parseFloat(parseResult[4]), parseFloat(parseResult[5]), parseFloat(parseResult[6]), parseFloat(parseResult[7]), 0, 0, 0, 0, 0, 0, 0, 'UTC');
        }
        ...
        if (arguments.length === 0) {
            ...
            if (!isNumber && typeof arguments[0] === 'string') {
                ...
                if (arguments[0] === 'today') {
                    ...
                    _date = that.tryparseDate(arguments[0]);
                }

                if (_date) {
                    that.dateData = that.dateToMS(_date.getFullYear(), _date.getMonth() + 1, _date.getDate()) + that.timeToMS(_date.getHours(), _date.getMinutes(), _date.getSeconds(), _date.getMilliseconds());
                }
            } else {
                if (typeof arguments[0] === 'number') {
                    ...
                    if (arguments[0] instanceof Date) {
                        var _date2 = arguments[0];
                        that.dateData = that.dateToMS(_date2.getFullYear(), _date2.getMonth() + 1, _date2.getDate()) + that.timeToMS(_date2.getHours(), _date2.getMinutes(), _date2.getSeconds(), _date2.getMilliseconds());
                    } else {
                        that.dateData = arguments[0];
                    }
                }
            ...
            var _isNumber = typeof arguments[0] === 'number' && isFinite(arguments[0]);

            if (!_isNumber && typeof arguments[0] === 'string') {
                var _date3 = void 0;
                ...
                if (arguments[0] === 'today') {
                    ...
                    _date3 = new Date();
                    _date3.setHours(0, 0, 0, 0);
                } else if (that.regexISOString.test(arguments[0])) {
                    getUTCDate(arguments[0]);
                } else {
                    _date3 = that.tryparseDate(arguments[0]);
                }

                if (_date3) {
                    that.dateData = that.dateToMS(_date3.getFullYear(), _date3.getMonth() + 1, _date3.getDate()) + that.timeToMS(_date3.getHours(), _date3.getMinutes(), _date3.getSeconds(), _date3.getMilliseconds());
                }
            } else {
                if (typeof arguments[0] === 'number') {
                    that.dateData = arguments[0];
                    ...
                    if (arguments[0] instanceof Date) {
                        var _date4 = arguments[0];
                        that.dateData = that.dateToMS(_date4.getFullYear(), _date4.getMonth() + 1, _date4.getDate()) + that.timeToMS(_date4.getHours(), _date4.getMinutes(), _date4.getSeconds(), _date4.getMilliseconds());
                    } else {
                        that.dateData = arguments[0];
                    }
                }
            ...
            if (typeof arguments[0] === 'string') {
                var _date5 = that.tryparseDate(arguments[0], arguments[2], arguments[1]);
                that.dateData = that.dateToMS(_date5.getFullYear(), _date5.getMonth() + 1, _date5.getDate()) + that.timeToMS(_date5.getHours(), _date5.getMinutes(), _date5.getSeconds(), _date5.getMilliseconds());
            } else {
                var year = arguments[0],
                    ...
                    _date6 = new Date(year, month, day, hour, minute, second, millisecond);

                if (year < 1970) {
                    _date6.setFullYear(year);
                }

                that.dateData = that.dateToMS(_date6.getFullYear(), _date6.getMonth() + 1, _date6.getDate()) + that.timeToMS(_date6.getHours(), _date6.getMinutes(), _date6.getSeconds(), _date6.getMilliseconds());
        ...
        if (UTCDate) {
            var convertedUTCDate = UTCDate.toTimeZone(that.timeZone);
    ...
    babelHelpers.createClass(DateTime, [{
        ...
        key: 'weekOfYear',
        value: function weekOfYear(firstDay) {
            var that = this,
                dateObj = that.toDate(),
                dowOffset = firstDay || that.calendar.firstDay,
        ...
        key: 'dateToMS',
        value: function dateToMS(year, month, day) {
            var that = this;
        ...
        key: 'timeToMS',
        value: function timeToMS(hour, minute, second, ms) {
            var that = this;
        ...
        key: 'arrayIndexOf',
        value: function arrayIndexOf(array, item) {
            return array.indexOf(item);
        }
    }, {
        key: 'startsWith',
        value: function startsWith(value, pattern) {
            return value.indexOf(pattern) === 0;
        }
    }, {
        key: 'endsWith',
        value: function endsWith(value, pattern) {
        ...
        key: 'expandFormat',
        value: function expandFormat(calendar, format) {
        ...
        key: 'getEra',
        value: function getEra(date, eras) {
            if (!eras) return 0;
        ...
        key: 'toUpperArray',
        value: function toUpperArray(arr) {
            var results = [];
        ...
        key: 'getEraYear',
        value: function getEraYear(date, cal, era, sortable) {
        ...
        key: 'getDayIndex',
        value: function getDayIndex(cal, value, abbr) {
            var that = this,
                days = cal.days;
            var ret = void 0,
        ...
        key: 'getMonthIndex',
        value: function getMonthIndex(cal, value, abbr) {
            var that = this;
        ...
        key: 'appendPreOrPostMatch',
        value: function appendPreOrPostMatch(preMatch, strings) {
        ...
        key: 'tryparseDate',
        value: function tryparseDate(value, calendar, format) {
            var that = this;
            ...
            if (format !== undefined) {
                if (Array.isArray(format)) {
                    for (var i = 0; i < format.length; i++) {
                        var _tryParse = that.parseDate(value, format[i], calendar);
            ...
            for (var prop in defaultPatterns) {
                var _date7 = that.parseDate(value, defaultPatterns[prop], calendar);
            ...
            for (var _prop in patterns) {
                var _date8 = that.parseDate(value, patterns[_prop], calendar);
            ...
            if (typeof value === 'string') {
                ...
                var parsed = false;
                if (datePart) {
                    for (var _i = 0; _i < splitParts.length; _i++) {
                        if (datePart.indexOf(splitParts[_i]) >= 0) {
                            dateParts = datePart.split(splitParts[_i]);
                            break;
                        }
                    }
                    ...
                    var dayPart = null;
                    var monthPart = null;
                    for (var _i2 = 0; _i2 < dateParts.length; _i2++) {
                        var part = dateParts[_i2];
                    ...
                    for (var _i3 = 0; _i3 < dateParts.length; _i3++) {
                        var _part = dateParts[_i3],
                            isMonth = that.parseDate(_part, 'M', calendar) || that.parseDate(_part, 'MM', calendar) || that.parseDate(_part, 'MMM', calendar) || that.parseDate(_part, 'MMMM', calendar);
                        if (isMonth) {
                            if (dayPart !== null && dayPart !== undefined && dayPart === _i3) continue;
                    ...
                    for (var _i4 = 0; _i4 < dateParts.length; _i4++) {
                        var _part2 = dateParts[_i4];
                        var isYear = that.parseDate(_part2, 'yyyy', calendar);
                        if (isYear) {
                            if (dayPart !== null && dayPart !== undefined && dayPart === _i4) continue;

                            if (monthPart !== null && monthPart !== undefined && monthPart === _i4) continue;
                    ...
                    for (var d = days.length - 1; d >= 0; d--) {
                        for (var _m = 0; _m < months.length; _m++) {
                            for (var y = 0; y < years.length; y++) {
                                var _result = new Date(years[y], months[_m], days[d]);
                                if (years[y] < 1970) _result.setFullYear(years[y]);
            ...
            if (value !== null && value !== undefined) {
                dateParts = [':', '/', '-'];
                var canParse = true;
                for (var _part3 = 0; _part3 < dateParts.length; _part3++) {
                    if (value.indexOf(dateParts[_part3]) !== -1) {
                        canParse = false;
                    }
                }
        ...
        key: 'getParseRegExp',
        value: function getParseRegExp(cal, format) {
            var that = this;
        ...
        key: 'outOfRange',
        value: function outOfRange(value, low, high) {
            return value < low || value > high;
        }
    }, {
        key: 'expandYear',
        value: function expandYear(cal, year) {
            var that = this;
        ...
        key: 'parseDate',
        value: function parseDate(value, format, calendar) {
            var that = this;
            ...
            for (var j = 0, jl = groups.length; j < jl; j++) {
                ...
                if (matchGroup) {
                    ...
                    switch (current) {
                        ...
                        default:
                            {
                                var precisionDigits = matchGroup;
        ...
        key: 'toString',
        value: function toString(format, calendar) {
            var that = this;
            ...
            var formatStamp = that.dateData.toString() + that.getFractionsOfSecondStamp() + format + (that.timeZone || '');
            ...
            if (!format || !format.length || format === 'i') {
                var _ret = void 0;
                _ret = that.formatDate(value, calendar.patterns.F, calendar);
                return _ret;
            }
            ...
            for (;;) {
                ...
                switch (current) {
                    ...
                    case 'zz':
                        ...
                        ret.push((that.timeZoneOffsetHours >= 0 ? '+' : '-') + that.padZeros(Math.floor(Math.abs(that.timeZoneOffsetHours)), clength));
                        break;
                    case 'zzz':
                        //    // Time zone offset with leading zero
                        //    hour = value.getTimezoneOffset() / 60;
                        ...
                        ret.push((that.timeZoneOffsetHours >= 0 ? '+' : '-') + that.padZeros(Math.floor(Math.abs(that.timeZoneOffsetHours)), 2) + ':' + that.padZeros(Math.abs(that.timeZoneOffsetHours % 1) * 60, 2));
                        break;
                    case 'g':
                    case 'gg':
                        if (calendar.eras) {
        ...
        key: 'getFractionsOfSecondStamp',
        value: function getFractionsOfSecondStamp() {
            var that = this;
        ...
        key: 'getFirstNDigitsOfPrecision',
        value: function getFirstNDigitsOfPrecision(precision, noMilliseconds) {
            var that = this,
                result = '' + (noMilliseconds !== true ? that.padZeros(that.millisecond(), 3) : '') + that.padZeros(that._microsecond, 3) + that.padZeros(that._nanosecond, 3) + that.padZeros(that._picosecond, 3) + that.padZeros(that._femtosecond, 3) + that.padZeros(that._attosecond, 3) + that.padZeros(that._zeptosecond, 3) + that.padZeros(that._yoctosecond, 3);

            return result.slice(0, precision);
        }
    }, {
        key: 'copySmallTimePartValues',
        value: function copySmallTimePartValues(newDate) {
            var that = this;
        ...
        key: 'add',
        value: function add(value, scale, createNew) {
            var that = this;
            ...
            if (scale === undefined) {
                ...
                var _newDate = new JQX.Utilities.DateTime(ms + parseInt(value._ticks / that.ticksPerMillisecond));
                that.copyTimeZone(_newDate);
                that.copySmallTimePartValues(_newDate);
                return _newDate;
            }
            ...
            var newDate = new JQX.Utilities.DateTime(ms + millis);
        ...
        key: 'addDays',
        value: function addDays(value, createNew) {
            var that = this;
        ...
        key: 'addHours',
        value: function addHours(value, createNew) {
            var that = this;
        ...
        key: 'addDeciseconds',
        value: function addDeciseconds(value, createNew) {
            return this.add(value * 100, 1, createNew);
        }
    }, {
        key: 'addCentiseconds',
        value: function addCentiseconds(value, createNew) {
            return this.add(value * 10, 1, createNew);
        }
    }, {
        key: 'addMilliseconds',
        value: function addMilliseconds(value, createNew) {
            return this.add(value, 1, createNew);
        }
    }, {
        key: 'addMinutes',
        value: function addMinutes(value, createNew) {
            var that = this;
        ...
        key: 'addMonths',
        value: function addMonths(months, createNew) {
            var that = this;
            ...
            var newDate = new JQX.Utilities.DateTime(that.dateToMS(y, m, d) + that.internalMS() % that.millisPerDay);
            that.copyTimeZone(newDate);
            that.copySmallTimePartValues(newDate);
            return newDate;
        }
        ...
        key: 'addSeconds',
        value: function addSeconds(value, createNew) {
            var that = this;
        ...
        key: 'addYears',
        value: function addYears(value, createNew) {
        ...
        key: 'addMicroseconds',
        value: function addMicroseconds(value, createNew) {
            if (value === 0) {
                return;
            }

            var that = this;
            var millisecondsToAdd = void 0,
                microseconds = void 0;

            if (value < 0 && that.hour() === 0 && that.minute() === 0 && that.second() === 0 && that.millisecond() === 0 && that._microsecond === 0) {

                millisecondsToAdd = parseInt(value / 1000, 10) - 1;
                microseconds = 1000 + value % 1000;
            }

            var totalMilliseconds = that.timeToMS(that.hour(), that.minute(), that.second(), that.millisecond()) * 1000 + that._microsecond,
        ...
        key: 'addFractionsOfSecond',
        value: function addFractionsOfSecond(value, createNew, unit, biggerUnit, biggerUnitMethod) {
            if (value === 0) {
                return;
            }
            ...
            var biggerUnitToAdd = parseInt(updatedTotal / 1000, 10) - parseInt(total / 1000, 10),
                units = parseInt(updatedTotal % 1000, 10),
                newDateTimeObject = void 0;
        ...
        key: 'addNanoseconds',
        value: function addNanoseconds(value, createNew) {
        ...
        key: 'addPicoseconds',
        value: function addPicoseconds(value, createNew) {
        ...
        key: 'addFemtoseconds',
        value: function addFemtoseconds(value, createNew) {
        ...
        key: 'addAttoseconds',
        value: function addAttoseconds(value, createNew) {
        ...
        key: 'addZeptoseconds',
        value: function addZeptoseconds(value, createNew) {
        ...
        key: 'addYoctoseconds',
        value: function addYoctoseconds(value, createNew) {
        ...
        key: 'isInDaylightSavingTime',
        value: function isInDaylightSavingTime() {
            var today = new Date(),
        ...
        value: function supportsDaylightSavingTime() {
            var today = new Date(),
                winter = new Date(today.getFullYear(), 0, 1),
                summer = new Date(today.getFullYear(), 6, 1);
        ...
        key: 'microsecond',
        value: function microsecond() {
            return this._microsecond;
        }
    }, {
        key: 'nanosecond',
        value: function nanosecond() {
            return this._nanosecond;
        }
    }, {
        key: 'picosecond',
        value: function picosecond() {
            return this._picosecond;
        }
    }, {
        key: 'femtosecond',
        value: function femtosecond() {
            return this._femtosecond;
        }
    }, {
        key: 'attosecond',
        value: function attosecond() {
            return this._attosecond;
        }
    }, {
        key: 'zeptosecond',
        value: function zeptosecond() {
            return this._zeptosecond;
        }
    }, {
        key: 'yoctosecond',
        value: function yoctosecond() {
        ...
        value: function equals(date) {
            ...
            return that.dateData === date.dateData && that._microsecond === date._microsecond && that._nanosecond === date._nanosecond && that._picosecond === date._picosecond && that._femtosecond === date._femtosecond && that._attosecond === date._attosecond && that._zeptosecond === date._zeptosecond && that._yoctosecond === date._yoctosecond;
        }
    }, {
        key: 'equalDateParts',
        value: function equalDateParts(date) {
            var that = this;

            if (that.year() === date.year() && that.month() === date.month() && that.day() === date.day()) {
                return true;
            }
        ...
        value: function compare(date) {
            ...
            var timeParts = ['dateData', '_microsecond', '_nanosecond', '_picosecond', '_femtosecond', '_attosecond', '_zeptosecond', '_yoctosecond'];
        ...
        key: 'copyTimeZone',
        value: function copyTimeZone(newDateTime) {
            var that = this;
        ...
        key: 'validateDate',
        value: function validateDate(value, referenceValue, formatString) {
            ...
            try {
                if (new RegExp(/^\d{1,2}\/\d{1,2}\/\d{4}(, \d{1,2}:\d{2}:\d{1,2} [A|P]M)?$/).test(value)) {
                    var constructedDate = new Date(value);
        ...
        key: 'parseDateString',
        value: function parseDateString(value, referenceValue, formatString) {
            var parseAttemptDate = new Date(value);
            ...
            try {
                var splitValue = validValue.split(',');
        ...
        key: 'fromFullTimeStamp',
        value: function fromFullTimeStamp(timeStamp) {
            timeStamp = timeStamp.toString();

            var dateTime = new JQX.Utilities.DateTime(parseFloat(timeStamp.slice(0, timeStamp.length - 21)));
            var smallTimeParts = timeStamp.slice(timeStamp.length - 21),
                unitIndex = 0;
        ...
        value: function getConstructorParameters(oldValue) {
            return [oldValue.year(), oldValue.month(), oldValue.day(), oldValue.hour(), oldValue.minute(), oldValue.second(), oldValue.millisecond(), oldValue._microsecond, oldValue._nanosecond, oldValue._picosecond, oldValue._femtosecond, oldValue._attosecond, oldValue._zeptosecond, oldValue._yoctosecond, oldValue.timeZone];
        }
        ...
        key: 'detectDisplayMode',
        value: function detectDisplayMode(value, formatString, formatStringRegExp) {
        ...
        key: 'getLocalizedNames',
        value: function getLocalizedNames(locale) {
            var days = { names: [], namesAbbr: [], namesShort: [] },
            ...
            for (var _i5 = 0; _i5 < 12; _i5++) {
                var _date9 = new Date(2017, _i5, 1),
                    _name = _date9.toLocaleString(locale, { 'month': 'long' });

                months.names.push(_name);
                months.namesAbbr.push(_name.substring(0, 3));
            }
