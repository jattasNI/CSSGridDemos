...
*/
JQX('jqx-tooltip', function (_JQX$ContentElement) {
    babelHelpers.inherits(Tooltip, _JQX$ContentElement);
    ...
    babelHelpers.createClass(Tooltip, [{
        ...
        */
        ...
        value: function propertyChangedHandler(propertyName, oldValue, newValue) {
            babelHelpers.get(Tooltip.prototype.__proto__ || Object.getPrototypeOf(Tooltip.prototype), 'propertyChangedHandler', this).call(this, propertyName, oldValue, newValue);
        ...
        */
        ...
        value: function ready() {
            ...
            babelHelpers.get(Tooltip.prototype.__proto__ || Object.getPrototypeOf(Tooltip.prototype), 'ready', this).call(this);
        ...
        */
        ...
        value: function _applyPosition() {
            ...
            function getElementAndOwnerRelation() {
                var tooltipDistanceToBody = getDomElementPosition(that),
                    tooltipLevelsNumber = tooltipDistanceToBody.length;
                var itemWithNonStaticPosition = null,
                    rect = that._ownerElement.getBoundingClientRect();

                for (var i = 0; i < tooltipLevelsNumber; i++) {
                    var style = window.getComputedStyle(tooltipDistanceToBody[i]);
            ...
            var ownerRectData = that._ownerElement.getBoundingClientRect(),
            ...
            var positionObject = getElementAndOwnerRelation(),
            ...
            switch (position) {
                ...
                case 'right':
                    {
                        var pos = that['_position' + position.charAt(0).toUpperCase() + position.slice(1)](leftPosition, topPosition, positionObject);
        ...
        key: '_positionAuto',
        value: function _positionAuto(leftPosition, topPosition, positionObject) {
            var that = this;
            var parentElement = that._ownerElement.parentElement,
                overflowParent = void 0;
            ...
            var possiblePosition = that._positionTop(leftPosition, topPosition, positionObject),
            ...
            if (nonStaticParent) {
                var nonStaticParentRect = nonStaticParent.getBoundingClientRect();
            ...
            if (possiblePosition.top + nonStaticParentTop >= overFlowParentRect.top) {
                ...
                leftPosition = Math.max(overFlowParentRect.left - nonStaticParentLeft, possiblePosition.left + Math.min(0, overFlowParentRect.right - (possiblePosition.left + nonStaticParentLeft + that.offsetWidth)));
            ...
            topPosition = Math.max(overFlowParentRect.top - nonStaticParentTop, possiblePosition.top + Math.min(0, overFlowParentRect.bottom - (possiblePosition.top + nonStaticParentTop + that.offsetHeight)));
        ...
        key: '_positionTop',
        value: function _positionTop(leftPosition, topPosition, positionObject) {
            var that = this;
            ...
            if (that._isParentPositionStatic) {
                ...
                if (that._ownerElement instanceof SVGElement) {
                    // to be applied in all modes
                    var rect = that._ownerElement.getBoundingClientRect(),
            ...
            if (that._ownerElement instanceof SVGElement && that._ownerElement.parentElement) {
                // to be applied in all modes; position to be recalculated
                var _rect = that._ownerElement.getBoundingClientRect(),
                    _rectParent = that._ownerElement.parentNode.getBoundingClientRect();

                topPosition = _rect.top - _rectParent.top - that.offsetHeight;
                leftPosition = _rect.left - _rectParent.left - that.offsetWidth / 2 + _rect.width / 2;
        ...
        key: '_positionBottom',
        value: function _positionBottom(leftPosition, topPosition, positionObject) {
            var that = this;
        ...
        key: '_positionLeft',
        value: function _positionLeft(leftPosition, topPosition, positionObject) {
            var that = this;
        ...
        key: '_positionRight',
        value: function _positionRight(leftPosition, topPosition, positionObject) {
            var that = this;
        ...
        * @param {any} event
        ...
        key: '_eventsHandler',
        value: function _eventsHandler(event) {
            var that = this;
        ...
        */
        ...
        key: '_handleEventListeners',
        value: function _handleEventListeners(oldValue) {
            var that = this;
        ...
        key: '_handleSelector',
        value: function _handleSelector(newValue) {
            var that = this;
        ...
        */
        ...
        key: '_handleTemplate',
        value: function _handleTemplate(oldValue) {
            var that = this;
            var template = that.tooltipTemplate;
            ...
            for (var _i2 = 0; _i2 < clone.childNodes.length; _i2++) {
                if (clone.childNodes[_i2].outerHTML) {
                    that.$.content.innerHTML += clone.childNodes[_i2].outerHTML;
                }
            }
        }
    }], [{
