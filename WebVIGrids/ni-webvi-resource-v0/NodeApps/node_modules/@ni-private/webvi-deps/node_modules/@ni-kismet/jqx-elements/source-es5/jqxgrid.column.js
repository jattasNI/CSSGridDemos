...
JQX.Utilities.Assign('Grid.Column', function () {
    ...
    babelHelpers.createClass(Column, [{
        ...
        value: function propertyChanged(propertyName, oldValue, newValue) {
            ...
            if (propertyName === 'allowSort' || propertyName === 'allowFilter') {
                that.refresh();
                return;
            }
            ...
            if (propertyName === 'label' || propertyName === 'width' || propertyName === 'minWidth') {
                that.grid.refresh();
            }
            ...
            if (propertyName === 'freeze') {
                if (!newValue) {
                    if (that.freeze === true || that.freeze === 'near') {
                        ...
                        var index = that.grid._frozenNearColumns.indexOf(that);

                        if (index >= 0) {
                            that.grid._frozenNearColumns.splice(index, 0, 0);
                        }
                    } else if (that.freeze === 'far') {
                        var _index = that.grid._frozenFarColumns.indexOf(that);

                        if (_index >= 0) {
                            that.grid._frozenFarColumns.splice(_index, 0, 0);
                        }
                    }
                } else {
        ...
        value: function createElement() {
            var that = this;
            var element = document.createElement('jqx-grid-column');
...
JQX('jqx-grid-column', function (_JQX$BaseElement) {
    ...
    babelHelpers.createClass(Column, [{
        key: '_showSortButton',
        value: function _showSortButton(refresh) {
            var that = this;
        ...
        key: '_hideSortButton',
        value: function _hideSortButton(refresh) {
            var that = this;
        ...
        key: '_showFilterButton',
        value: function _showFilterButton() {
            var that = this;
        ...
        key: '_hideFilterButton',
        value: function _hideFilterButton() {
            var that = this;
        ...
        key: '_showDescriptionButton',
        value: function _showDescriptionButton() {
            var that = this;
        ...
        key: '_hideDescriptionButton',
        value: function _hideDescriptionButton() {
            var that = this;
        ...
        key: '_showCustomButton',
        value: function _showCustomButton() {
            var that = this;
        ...
        key: '_hideCustomButton',
        value: function _hideCustomButton() {
            var that = this;
        ...
        key: '_showActionButton',
        value: function _showActionButton() {
            var that = this;
        ...
        key: '_hideActionButton',
        value: function _hideActionButton() {
            var that = this;
        ...
        value: function _refresh() {
            ...
            if (that.column.dataField === '_checkBoxColumn') {
                ...
                var selectedRows = grid.paging.enabled && grid.selection.checkBoxes.selectAllMode === 'page' ? grid._getSelectedRows(true, true) : grid._getSelectedRows(true, false);
            ...
            if (that.column.dataField === '_commandColumn') {
                var _grid = that.column.grid;
                var showLabel = _grid.editing.commandColumn.displayMode !== 'icon';
                var showIcon = _grid.editing.commandColumn.displayMode !== 'label';
                var properties = _grid.editing.commandColumn.dataSource.commandColumnMenu;

                var commandColumnItem = '<div class="jqx-grid-command-item">';

                var label = properties.label === '{{messages}}' ? _grid.localize('commandColumnMenu') : properties.label;
            ...
            var selected = that.column.getProperty('selected');
            ...
            var buttonsCount = that.column.showIcon ? 1 : 0;

            for (var i = 0; i < that.buttonsGroup.children.length; i++) {
        ...
        value: function _render() {
            ...
            var columnDataField = that.column.dataField ? that.column.dataField : '';
            var isLastColumn = that.column === that.column.grid._lastVisibleColumn;
        ...
        key: '_initialize',
        value: function _initialize(column) {
            var that = this;
            ...
            var upEvent = window.PointerEvent ? 'pointerup' : 'mouseup';
