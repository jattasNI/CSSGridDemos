...
*/
JQX('jqx-drop-down-button', function (_JQX$ContentElement) {
    babelHelpers.inherits(DropDownButton, _JQX$ContentElement);

    function DropDownButton() {
        babelHelpers.classCallCheck(this, DropDownButton);
        return babelHelpers.possibleConstructorReturn(this, (DropDownButton.__proto__ || Object.getPrototypeOf(DropDownButton)).apply(this, arguments));
    }

    babelHelpers.createClass(DropDownButton, [{
        key: 'template',
        ...
        */
        ...
        value: function attached() {
            ...
            babelHelpers.get(DropDownButton.prototype.__proto__ || Object.getPrototypeOf(DropDownButton.prototype), 'attached', this).call(this);
        ...
        value: function detached() {
            ...
            babelHelpers.get(DropDownButton.prototype.__proto__ || Object.getPrototypeOf(DropDownButton.prototype), 'detached', this).call(this);
                ...
                case 'innerHTML':
                    ...
                    if (newValue.trim() === '') {
                        ...
                        requestAnimationFrame(function () {
                            return that.$.scrollViewer.$.scrollViewerContentContainer.innerHTML = that.dropDownPlaceholder;
                        });
                    } else {
        ...
        */
        ...
        value: function open() {
            ...
            for (var i = 0; i < dropDownsInDOM.length; i++) {
        ...
        value: function ready() {
            babelHelpers.get(DropDownButton.prototype.__proto__ || Object.getPrototypeOf(DropDownButton.prototype), 'ready', this).call(this);
        ...
        */
        ...
        value: function _keyDownHandler(event) {
            ...
            if (that.disabled || that.readonly || activeElement !== that && activeElement !== that.$.dropDownButton && activeElement !== that.$.actionButton) {
                return;
            }
