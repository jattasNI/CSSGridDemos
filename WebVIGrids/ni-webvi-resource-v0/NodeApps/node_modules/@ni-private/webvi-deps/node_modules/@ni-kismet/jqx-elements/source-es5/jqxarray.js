 ...
 */
JQX('jqx-array', function (_JQX$BaseElement) {
    babelHelpers.inherits(DataArray, _JQX$BaseElement);

    function DataArray() {
        babelHelpers.classCallCheck(this, DataArray);
        return babelHelpers.possibleConstructorReturn(this, (DataArray.__proto__ || Object.getPrototypeOf(DataArray)).apply(this, arguments));
    }

    babelHelpers.createClass(DataArray, [{
        key: 'template',
        ...
        value: function ready() {
            babelHelpers.get(DataArray.prototype.__proto__ || Object.getPrototypeOf(DataArray.prototype), 'ready', this).call(this);
        ...
        key: 'addDimension',
        value: function addDimension(changeValueDimensions) {
            var that = this;
            ...
            var indexer = document.createElement('jqx-numeric-text-box');
        ...
        key: 'copyElementValueToClipboard',
        value: function copyElementValueToClipboard(rowVisibleIndex, columnVisibleIndex) {
            var that = this,
        ...
        key: 'endSelection',
        value: function endSelection(rowBoundIndex, columnBoundIndex) {
            var that = this;
        ...
        key: 'getElement',
        value: function getElement(rowVisibleIndex, columnVisibleIndex) {
        ...
        key: 'getIndexerValue',
        value: function getIndexerValue() {
        ...
        value: function hitTest(x, y) {
            ...
            var closestArrayElement = topMostElement.closest('.jqx-array-element'),
            ...
            if (closestArrayElement !== null) {
                ...
                var dimension = closestIndexer.dimension;
        ...
        value: function insertColumnBefore(index, redirect) {
            var that = this,
                oldValue = JSON.stringify(that.value),
                lV = that.arrayIndexingMode === 'LabVIEW';
            var boundColumnIndex = void 0;
            ...
            if (that.dimensions === 1) {
                ...
                if (lV) {
                    ...
                    var targetLevel = that.dimensions - 2,
                        recursion = function recursion(arr, level) {
                        if (targetLevel !== level) {
                            for (var i = 0; i < arr.length; i++) {
                                recursion(arr[i], level + 1);
                            }
        ...
        key: 'insertRowBefore',
        value: function insertRowBefore(index, redirect) {
            var that = this,
                oldValue = JSON.stringify(that.value),
                lV = that.arrayIndexingMode === 'LabVIEW';
        ...
        key: 'reinitializeArray',
        value: function reinitializeArray() {
            var that = this;
        ...
        key: 'removeDimension',
        value: function removeDimension(propertyChangedHandler, changeValueDimensions) {
            var that = this,
        ...
        key: 'reset',
        value: function reset(propertyChangedHandler) {
            var that = this;
        ...
        key: 'resizeElement',
        value: function resizeElement(width, height) {
            var that = this;
            ...
            var cellWidgets = that.getElementsByClassName('jqx-array-element-' + that._id);
        ...
        key: 'selectElement',
        value: function selectElement(rowBoundIndex, columnBoundIndex) {
            var that = this;
        ...
        key: 'setColumnWidth',
        value: function setColumnWidth(width, propertyChangedHandler) {
            var that = this;
        ...
        key: 'setDefaultValue',
        value: function setDefaultValue(newDefaultValue) {
            var that = this;
        ...
        key: 'setIndexerValue',
        value: function setIndexerValue(settings) {
            var that = this;
            var changed = false;
        ...
        key: 'setRowHeight',
        value: function setRowHeight(height, propertyChangedHandler) {
            var that = this;
        ...
        key: 'showLastElement',
        value: function showLastElement() {
            var that = this,
                settings = [];
            var xDimension = void 0,
                yDimension = void 0;
            ...
            if (that.dimensions === 1) {
                var indexerValue = parseFloat(that._indexers[0].value),
            ...
            for (var i = 0; i < that.dimensions; i++) {
                ...
                if (i === xDimension) {
                    var _indexerValue = parseFloat(that._indexers[i].value);

                    if (!(_indexerValue + that.columns < currentValue + 1 || _indexerValue > currentValue)) {
                        currentValue = _indexerValue;
                    }
                } else if (i === yDimension) {
                    var _indexerValue2 = parseFloat(that._indexers[i].value);

                    if (!(_indexerValue2 + that.rows < currentValue + 1 || _indexerValue2 > currentValue)) {
                        currentValue = _indexerValue2;
                    }
                }
        ...
        key: 'startSelection',
        value: function startSelection(rowBoundIndex, columnBoundIndex) {
            var that = this;
        ...
        key: 'toggleElementGap',
        value: function toggleElementGap() {
            var that = this;
        ...
        key: 'val',
        value: function val(newValue, elementIndexes) {
            var that = this;
            var oldValue = void 0;
            ...
            if (arguments.length === 2) {
                ...
                if (newValue !== undefined && !((typeof newValue === 'undefined' ? 'undefined' : babelHelpers.typeof(newValue)) === 'object' && Object.keys(newValue).length === 0)) {
                    if (that.type === 'none') {
                        return;
                    }
        ...
        value: function propertyChangedHandler(propertyName, oldValue, newValue) {
            babelHelpers.get(DataArray.prototype.__proto__ || Object.getPrototypeOf(DataArray.prototype), 'propertyChangedHandler', this).call(this, propertyName, oldValue, newValue);
            ...
            if (newValue !== oldValue) {
                switch (propertyName) {
                    ...
                    case 'animation':
                    case 'disabled':
                        for (var j = 0; j < that._indexers.length; j++) {
                    ...
                    case 'elementTemplate':
                        if (that.type !== 'none') {
                            var _cellWidgets = that.getElementsByClassName('jqx-array-element-' + that._id);

                            for (var k = 0; k < _cellWidgets.length; k++) {
                                var currentWidget = _cellWidgets[k];
                    ...
                    case 'elementWidth':
                        ...
                        break;
                    case 'indexerHeight':
                        for (var o = 0; o < that._indexers.length; o++) {
        ...
        value: function _addDimensionToJSArray(dimensions) {
            var that = this;
        ...
        key: '_addElementHandlers',
        value: function _addElementHandlers(element) {
            var that = this;
        ...
        key: '_addElementStructure',
        value: function _addElementStructure() {
            var that = this;
        ...
        value: function _addInitialDimensions() {
            var that = this,
        ...
        key: '_addRemoveColumn',
        value: function _addRemoveColumn(action) {
            var that = this;
        ...
        key: '_addRemoveMultipleDimensions',
        value: function _addRemoveMultipleDimensions(oldvalue, value, changeValueDimensions) {
            var that = this;
            ...
            var difference = that.dimensions - oldvalue;
            ...
            if (that.showIndexDisplay === true && !(value !== 1 && (value - oldvalue > 0 && value * (that.indexerHeight + 4) - 2 < that._cachedHeight || value - oldvalue < 0 && oldvalue * (that.indexerHeight + 4) - 2 < that._cachedHeight)) || value === 1) {
                that._updateWidgetHeight('dimensions');
            }
        }
        ...
        key: '_addRemoveRow',
        value: function _addRemoveRow(action) {
            var that = this;
            ...
            if (action === 'add' && (that.dimensions > 1 || that.dimensions === 1 && that.columns === 1)) {
                ...
                var rowToRemove = that._tableBody.children[that._tableBody.children.length - 1],
        ...
        key: '_addSelectionClass',
        value: function _addSelectionClass(x, y, td, skipSelectionCheck) {
            var that = this;
        ...
        key: '_areDifferent',
        value: function _areDifferent(a, b) {
            ...
            if ((typeof a === 'undefined' ? 'undefined' : babelHelpers.typeof(a)) !== 'object' || (typeof a === 'undefined' ? 'undefined' : babelHelpers.typeof(a)) !== (typeof b === 'undefined' ? 'undefined' : babelHelpers.typeof(b))) {
                if (a !== b) {
                    return true;
                } else {
                    return false;
        ...
        value: function _changeRowsColumns(key, oldvalue, value, reset, suppressHeightUpdate) {
            var that = this,
        ...
        key: '_fillValueArray',
        value: function _fillValueArray(changedValueDimensions, skipOverride) {
            var that = this,
        ...
        key: '_getDefaultCellValue',
        value: function _getDefaultCellValue() {
            var that = this;
        ...
        value: function _getElementValue(element, dimensions, clone) {
            var that = this;
            var value = void 0;
        ...
        key: '_getInitialFill',
        value: function _getInitialFill() {
            var that = this;
        ...
        key: '_getMaxValuesOfScrollBars',
        value: function _getMaxValuesOfScrollBars(scrollbar) {
            var that = this,
        ...
        key: '_getValueInCell',
        value: function _getValueInCell(row, column) {
            var that = this,
                array = that.value,
        ...
        key: '_indexerChangeHandler',
        value: function _indexerChangeHandler(event) {
            var that = this,
                oldContext = that.context;

            that.context = that;

            var dimension = event.target.dimension,
        ...
        value: function _initializeElements(removeOldWidgets) {
            var that = this,
                cells = that._cells;
            ...
            if (that.type !== 'custom') {
                ...
                that._initializeElement = function (widget, value) {
                    if (that.elementTemplate) {
                        var widgetDimensions = { x: widget.col, y: widget.row };
        ...
        value: function _initializeWidget(i, j) {
            var that = this,
        ...
        key: '_inSelection',
        value: function _inSelection(x, y) {
            var that = this,
                dimensionValues = that._coordinates;
            var validation = true,
                xDimension = void 0,
            ...
            if (boundX >= that._absoluteSelectionStart[xDimension] && boundX <= that._absoluteSelectionEnd[xDimension] && boundY >= that._absoluteSelectionStart[yDimension] && boundY <= that._absoluteSelectionEnd[yDimension]) {
                validation = true;
            } else {
                validation = false;
            }
        ...
        key: '_moveScrollbar',
        value: function _moveScrollbar(scrollbar, type, index, value) {
            if (isNaN(value)) {
                return;
            }
        ...
        key: '_removeDimensionFromJSArray',
        value: function _removeDimensionFromJSArray() {
            var that = this;
            ...
            if (that.arrayIndexingMode === 'LabVIEW') {
                ...
                var dimensions = that.dimensions + 1,
                    recursion = function recursion(arr, level, parent, index) {
                    for (var i = 0; i < arr.length; i++) {
        ...
        value: function _resizeHandler() {
            ...
            if (that.offsetWidth !== that._cachedWidth) {
                if (that.type !== 'none') {
                    var valueDifference = that.offsetWidth - that._cachedWidth,
                    ...
                    var rowsColumnsDifference = Math.round(valueDifference / elementDimension),
                        oldValue = that.columns,
        ...
        key: '_returnEmptyArray',
        value: function _returnEmptyArray() {
            var that = this,
                emptyArray = [];
            var current = emptyArray;
        ...
        value: function _scrollbarChangeHandler(event) {
            var that = this;
        ...
        key: '_scrollbarClickHandler',
        value: function _scrollbarClickHandler(event) {
            var button = event.target.closest('.jqx-scroll-button');
            ...
            if (button === scrollbar.$.farButton) {
                ...
                var scrollbarMax = scrollbar.max;
        ...
        value: function _setElementValue(value, element, dimensions) {
            var that = this;
        ...
        key: '_setMaxValuesOfScrollBars',
        value: function _setMaxValuesOfScrollBars(which) {
            var that = this;
        ...
        key: '_showHorizontalScrollbar',
        value: function _showHorizontalScrollbar(show) {
            var that = this;
        ...
        key: '_showVerticalScrollbar',
        value: function _showVerticalScrollbar(show) {
            var that = this;
        ...
        key: '_syncScrollbar',
        value: function _syncScrollbar(dimension, value) {
            var that = this;
            var max = void 0,
                scrollbar = void 0;
        ...
        key: '_updateValue',
        value: function _updateValue(row, column, newValue) {
            var that = this,
        ...
        key: '_updateWidgetHeight',
        value: function _updateWidgetHeight(propertyChangedHandler) {
            var that = this,
                hScrollbarContainerSize = that.showHorizontalScrollbar ? 20 : 0;
            var mainHeight = void 0,
                indexerContaineHeight = void 0;

            if (that.showIndexDisplay) {
                var marginBottom = parseInt(window.getComputedStyle(that._indexers[0]).marginBottom, 10);
            ...
            if (that.type !== 'none') {
                ...
                if (propertyChangedHandler === 'showHorizontalScrollbar') {
                    var currentBigContainerHeight = that.$.bigContainer.offsetHeight;
        ...
        value: function _updateWidgetWidth(propertyChangedHandler) {
            ...
            var centralContainerWidth = void 0,
                bigContainerWidth = void 0,
                width = void 0;
        ...
        key: '_validateValueArrayDimensions',
        value: function _validateValueArrayDimensions() {
            var that = this;
            var dimensions = 0,
