(function () {
    ...
    class BindingModule {
        ...
        updateBoundMappedNodes() {
            ...
            for (let mapping in bindings.mapping) {
                let childNode = element.querySelector('[jqx-id="' + mapping + '"]');
                ...
                if (childNode) {
                    ...
                    const detachedChildNode = document.getElementById(element.getAttribute('aria-controls'));
        ...
        initProperties() {
            ...
            if (that._initProperties) {
                ...
                for (let i = 0; i < propertyNames.length; i++) {
                    ...
                    if (propertyValue.constructor === JQX.DataAdapter || propertyValue.constructor === JQX.Observable || typeof propertyValue !== 'object' || Utilities.Types.isArray(propertyValue)) {
    ...
    class ObservableArray {
        ...
        _createPropertyChangeData(propertyName, value, oldValue) {
            return {
                eventName: 'change', object: this, propertyName, value, oldValue
            };
        }
    ...
    window.addEventListener('load', function () {
        ...
        if (customElements.length > 0) {
            ...
            for (let j = 0; j < customElements.length; j++) {
                ...
                if (tagName === 'jqxItem') {
                    customElement = new window['jqxListItem'](element);
                }
                else {
    ...
    class App {
        ...
        _addModelBindings(ownerElement) {
            ...
            for (let i = 0; i < elements.length; i++) {
                ...
                let bind = {
                    value: element.getAttribute('jqx-model')
                };

                if (element.type === 'list') {
                    bind = {
                        selectedValues: element.getAttribute('jqx-model')
                    };
                }

                if (element.type === 'checkbox' || element.type === 'radio') {
                    bind = {
                        checked: element.getAttribute('jqx-model')
                    };
                }
        ...
        _observeData() {
            ...
            for (let dataItem in that.data) {
                ...
                else if (typeof dataItemValue === 'object' && dataItemValue.constructor === JQX.DataAdapter) {
                    that.data[dataItem].propertyName = dataItem;
                }
        ...
        _setPropertyFromData(item, propertyName) {
            ...
            if (item.bind.computed) {
                const computedObject = { item: item, name: boundPropertyName, value: dataItem };
