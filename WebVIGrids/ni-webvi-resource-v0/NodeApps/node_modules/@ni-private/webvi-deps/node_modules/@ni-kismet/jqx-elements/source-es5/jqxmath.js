...
var bigIntNativeSupport = void 0;
...
JQX.Utilities.Assign('BigNumber', function () {
    //+ Jonas Raoni Soares Silva
    //@ http://jsfromhell.com/classes/bignumber [rev. #4]

    function UtilitiesBigNumber(n, p, r) {
        babelHelpers.classCallCheck(this, UtilitiesBigNumber);
        ...
        if (JQX.Utilities.BigNumber.bigIntSupport) {
            ...
            try {
                ...
                try {
                    ...
                    var _result = BigInt(numberParts[0]),
                        firstDecimalDigit = parseInt(numberParts[1].charAt(0));

                    if (_result > 0 && firstDecimalDigit >= 5) {
                        _result = _result + BigInt(1);
                    } else if (_result < 0) {
    ...
    babelHelpers.createClass(UtilitiesBigNumber, [{
        key: 'add',
        value: function add(n) {
            ...
            var that = this.normalizeOperand(this);

            n = that.normalizeOperand(n);

            if (that.isZero() && that._s) {
                // that.toString() is '-0'
                that._s = false;
            }
            ...
            if (that._s != (n = new JQX.Utilities.BigNumber(n))._s) return n._s ^= 1, that.subtract(n);
            var o = new JQX.Utilities.BigNumber(that),
                a = o._d,
                b = n._d,
                la = o._f,
                lb = n._f,
        ...
        value: function subtract(n) {
            ...
            if (that._s != (n = new JQX.Utilities.BigNumber(n))._s) return n._s ^= 1, that.add(n);
            var o = new JQX.Utilities.BigNumber(that),
        ...
        value: function multiply(n) {
            ...
            var o = new JQX.Utilities.BigNumber(that),
                r = o._d.length >= (n = new JQX.Utilities.BigNumber(n))._d.length,
                a = (r ? o : n)._d,
                b = (r ? n : o)._d,
                la = a.length,
                lb = b.length,
                x = new JQX.Utilities.BigNumber(),
                i,
                j,
                s;
        ...
        value: function divide(n) {
            ...
            if ((n = new JQX.Utilities.BigNumber(n)) == '0') throw new Error('Division by 0');else if (that == '0') return new JQX.Utilities.BigNumber();
            var o = new JQX.Utilities.BigNumber(that),
                a = o._d,
                b = n._d,
                la = a.length - o._f,
                lb = b.length - n._f,
                r = new JQX.Utilities.BigNumber(),
                i = 0,
                j,
                s,
                l,
        ...
        value: function pow(n) {
            if (JQX.Utilities.BigNumber.bigIntSupport) {
                ...
                for (var _i = BigInt(0); _i < new JQX.Utilities.BigNumber(n)._d; _i = _i + BigInt(1)) {
        ...
        key: 'compare',
        value: function compare(n) {
            if (JQX.Utilities.BigNumber.bigIntSupport) {
                var otherNumber = new JQX.Utilities.BigNumber(n)._d;
            ...
            var a = that,
                la = that._f,
                b = new JQX.Utilities.BigNumber(n),
                lb = b._f,
                r = [-1, 1],
                i,
                l,
        ...
        key: 'valueOf',
        value: function valueOf(radix, wordLength) {
            var that = this.normalizeOperand(this);
        ...
        key: 'toString',
        value: function toString(radix, wordLength, leadingZeros) {
        ...
        key: 'normalizeOperand',
        value: function normalizeOperand(n) {
            if (n instanceof JQX.Utilities.BigNumber && typeof n._d === 'bigint') {
                return new JQX.Utilities.BigNumber(n._d.toString());
            }
