...
ni-graph-tools .ni-active-button.jqx-fill-state-disabled, 
ni-graph-tools .ni-toggle-autoscale-icon.ni-active-button {
    border-bottom: 4px solid #77baff;
}

ni-graph-tools:not([disabled]) .ni-active-button.jqx-fill-state-disabled {
    opacity: 1;
}
