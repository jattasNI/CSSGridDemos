...
export class TreeModel extends VisualModel {
    constructor(id) {
        super(id);
    ...
    getLocalEventInfo(eventName) {
        if (eventName === TreeModel.TREE_ITEM_CLOSED_EVENT_NAME) {
            return {
                eventIndex: TreeModel.TREE_ITEM_CLOSED_EVENT_INDEX,
                eventDataId: TreeModel.TREE_ITEM_CLOSED_EVENT_GUID
            };
        }
        if (eventName === TreeModel.TREE_ITEM_OPENED_EVENT_NAME) {
            return {
                eventIndex: TreeModel.TREE_ITEM_OPENED_EVENT_INDEX,
                eventDataId: TreeModel.TREE_ITEM_OPENED_EVENT_GUID
            };
        }
        if (eventName === TreeModel.TREE_SELECTION_CHANGED_EVENT_NAME) {
            return {
                eventIndex: TreeModel.TREE_SELECTION_CHANGED_EVENT_INDEX,
                eventDataId: TreeModel.TREE_SELECTION_CHANGED_EVENT_GUID
            };
        }
        return super.getLocalEventInfo(eventName);
    }
}
NIModelProvider.registerModel(TreeModel);
