...
export const FIT_TYPES = Object.freeze(["exact", "loose", "growloose", "none", "growexact", "auto"]);
export const FIT_INDICES = Object.freeze({
    "exact": 0,
    "loose": 1,
    "growloose": 2,
    "none": 3,
...
const RangePropertyNIType = new NIType({ name: NITypeNames.CLUSTER, fields: ['Minimum', 'Maximum'], subtype: [NITypeNames.DOUBLE, NITypeNames.DOUBLE] });
export class CartesianAxisModel extends VisualModel {
    constructor(id) {
        super(id);
...
NIModelProvider.registerModel(CartesianAxisModel);
