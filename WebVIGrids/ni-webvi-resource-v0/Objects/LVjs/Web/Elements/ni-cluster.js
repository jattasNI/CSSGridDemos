...
export class Cluster extends LayoutControl {
...
NIElementRegistrationService.registerElement(Cluster, NIElementRegistrationWeightEnum.CONTAINER);
VisualComponent.defineElementInfo(Cluster.prototype, 'ni-cluster', 'HTMLNICluster');
