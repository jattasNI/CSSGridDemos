...
export const PATH_TYPE_ENUM = Object.freeze({
    ABSOLUTE: 'absolute',
    RELATIVE: 'relative'
});
...
export class PathSelector extends Visual {
...
NIElementRegistrationService.registerElement(PathSelector);
VisualComponent.defineElementInfo(PathSelector.prototype, 'ni-path-selector', 'HTMLNIPathSelector');
