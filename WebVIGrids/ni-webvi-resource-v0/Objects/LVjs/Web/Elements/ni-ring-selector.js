...
// None
export class RingSelector extends NumericValueSelector {
...
NIElementRegistrationService.registerElement(RingSelector);
VisualComponent.defineElementInfo(RingSelector.prototype, 'ni-ring-selector', 'HTMLNIRingSelector');
