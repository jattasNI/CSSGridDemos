...
export class WebApplication extends NIElement {
    ...
    attachedCallback() {
        ...
        webApplicationModelsService.register(that);
        if (firstCall === true) {
    ...
    detachedCallback() {
        webApplicationModelsService.unregister(this);
    }
    start() {
...
NIElementRegistrationService.registerElement(WebApplication, NIElementRegistrationWeightEnum.WEBAPP);
NIElement.defineElementInfo(WebApplication.prototype, 'ni-web-application', 'HTMLNIWebApplication');
