...
//****************************************
import { InternationalizationStrings } from './niSupport.i18n.strings.js';
...
(function () {
    ...
    NI_SUPPORT.InternationalizationInitializer.TaskTracker = new TaskTracker(NI_SUPPORT.InternationalizationInitializer.TaskTrackerEnum, function () {
        NIElementRegistrationService.completeRegistration();
    ...
    const formatInternationalization = function (propertyName, replacements) {
        const propertyConfig = InternationalizationStrings[propertyName];
