...
export class NIEditorDataAdapters {
    ...
    static packedDataToJsModel(flatData, niType, options) {
        ...
        if (flatData instanceof Uint8Array) {
            result = NIPackedDataAdaptors.GetDataAdaptorFromPackedValue(flatData, niType, options);
        }
        else {
            result = NIPackedDataAdaptors.GetDataAdaptorFromIndex(flatData, niType, options);
        }
