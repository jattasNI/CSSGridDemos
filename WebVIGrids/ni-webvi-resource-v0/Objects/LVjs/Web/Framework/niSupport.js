...
//****************************************
import { INIElement } from '../Elements/ni-element-interface.js';
    ...
    static cloneControlElement(element) {
        ...
        switch (element.tagName) {
            ...
            case 'JQX-TOGGLE-BUTTON':
                { // The content that labVIEW sets for toggle button is different than its inner DOM, while loading or running the HTML page, the content is undefined
