 ...
 */
export class PackedGenericClusterValue {
    /**
    ...
    getBooleanField(clusterIndex) {
        const offset = this.bb.__offset(this.index, 4 + (2 * clusterIndex));
        return offset ? Boolean(this.bb.readInt8(this.index + offset)) : false;
    }
    /**
    ...
    getClusterElement(clusterIndex) {
        ...
        if (offset !== 0) {
            const result = new NIFlatBuffers.PackedData.PackedDataValue();
