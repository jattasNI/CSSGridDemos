...
export class NIPackedComplexDoubleAdaptor {
    ...
    static PackDataValue(builder, complexDataToPack, niType) {
        ...
        NIFlatBuffers.PackedData.PackedComplexFloat64Value.addImaginary(builder, complexDataToPack.imaginaryPart);
        NIFlatBuffers.PackedData.PackedComplexFloat64Value.addReal(builder, complexDataToPack.realPart);
