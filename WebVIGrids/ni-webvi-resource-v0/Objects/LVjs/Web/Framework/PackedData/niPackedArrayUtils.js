 ...
 */
export class NIPackedArrayUtils {
    /**
...
export class NITypeUtils {
    ...
    static ToNIType(packedType) {
        switch (packedType.dataTypeType()) {
            case NIFlatBuffers.PackedData.AnyPackedType.PackedScalarType:
                return NITypeUtils.ScalarTypeToNIType(packedType);
            case NIFlatBuffers.PackedData.AnyPackedType.PackedArrayType:
                return NITypeUtils.ArrayTypeToNIType(packedType);
            case NIFlatBuffers.PackedData.AnyPackedType.PackedClusterType:
                return NITypeUtils.ClusterTypeToNIType(packedType);
        }
    }
    static ArrayTypeToNIType(packedType) {
        const packedArrayType = packedType.dataType(new NIFlatBuffers.PackedData.PackedArrayType());
        const subType = NITypeUtils.ToNIType(packedArrayType.elementType);
        return subType.makeArray(packedArrayType.dimensions);
    }
    static ClusterTypeToNIType(packedType) {
        // TODO: Feature 86050
        throw new Error("ClusterTypeToNIType Method not implemented.");
    }
    static ScalarTypeToNIType(packedType) {
        const packedScalarType = packedType.dataType(new NIFlatBuffers.PackedData.PackedScalarType());
        switch (packedScalarType.typeType()) {
            case NIFlatBuffers.PackedData.AnyValue.PackedBooleanValue:
                return NITypes.BOOLEAN;
            case NIFlatBuffers.PackedData.AnyValue.PackedInt8Value:
                return NITypes.INT8;
            case NIFlatBuffers.PackedData.AnyValue.PackedUInt8Value:
                return NITypes.UINT8;
            case NIFlatBuffers.PackedData.AnyValue.PackedInt16Value:
                return NITypes.INT16;
            case NIFlatBuffers.PackedData.AnyValue.PackedUInt16Value:
                return NITypes.UINT16;
            case NIFlatBuffers.PackedData.AnyValue.PackedInt32Value:
                return NITypes.INT32;
            case NIFlatBuffers.PackedData.AnyValue.PackedUInt32Value:
                return NITypes.UINT32;
            case NIFlatBuffers.PackedData.AnyValue.PackedInt64Value:
                return NITypes.INT64;
            case NIFlatBuffers.PackedData.AnyValue.PackedUInt64Value:
                return NITypes.UINT64;
            case NIFlatBuffers.PackedData.AnyValue.PackedFloat32Value:
                return NITypes.SINGLE;
            case NIFlatBuffers.PackedData.AnyValue.PackedFloat64Value:
                return NITypes.DOUBLE;
            case NIFlatBuffers.PackedData.AnyValue.PackedStringValue:
                return NITypes.STRING;
            case NIFlatBuffers.PackedData.AnyValue.PackedComplexFloat32Value:
                return NITypes.COMPLEXSINGLE;
            case NIFlatBuffers.PackedData.AnyValue.PackedComplexFloat64Value:
                return NITypes.COMPLEXDOUBLE;
            case NIFlatBuffers.PackedData.AnyValue.PackedPathValue:
                return NITypes.PATH;
            case NIFlatBuffers.PackedData.AnyValue.PackedTimestampValue:
                return NITypes.TIMESTAMP;
            // TODO: additional scalar types (Feature 86050)
            // case NIFlatBuffers.PackedData.AnyValue.PackedVariantValue:
            //     return NITypes.VARIANT;
        }
        return NITypes.VOID;
    }
}
window.NITypeUtils = NITypeUtils;
window.NIPackedArrayUtils = NIPackedArrayUtils;
