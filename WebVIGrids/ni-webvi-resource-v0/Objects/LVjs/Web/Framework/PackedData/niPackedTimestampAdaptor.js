 ...
 */
export class NIPackedTimestampAdaptor {
    /**
    ...
    static PackDataValue(builder, timestampDataToPack) {
        NIFlatBuffers.PackedData.PackedTimestampValue.startPackedTimestampValue(builder);
        NIFlatBuffers.PackedData.PackedTimestampValue.addSeconds(builder, NIPackedTimestampAdaptor.CreateFlatbuffersLong(timestampDataToPack.seconds));
        NIFlatBuffers.PackedData.PackedTimestampValue.addFractions(builder, NIPackedTimestampAdaptor.CreateFlatbuffersLong(timestampDataToPack.fractions));
        return NIFlatBuffers.PackedData.PackedTimestampValue.endPackedTimestampValue(builder);
    }
    /**
     ...
     */
    unpack() {
        const timestampValue = new NIFlatBuffers.PackedData.PackedTimestampValue();
