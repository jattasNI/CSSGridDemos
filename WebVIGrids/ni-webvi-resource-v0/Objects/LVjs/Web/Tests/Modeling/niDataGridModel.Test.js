...
describe('A DataGridModel', function () {
    ...
    const height = 400;
    const visible = true;
    const value1 = [{ A: 'One' }, { A: 'Two' }, { A: 'Three' }];
    const value2 = [{ A: 'Four' }, { A: 'Five' }, { A: 'Six' }];
    ...
    beforeEach(function () {
        ...
        controlModel = new DataGridModel(niControlId);
    });
    // -------------------------------------------------
...
//# sourceMappingURL=niDataGridModel.Test.js.map