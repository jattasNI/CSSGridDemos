...
export class NumericTextBoxViewModel extends NumericControlViewModel {
...
NIModelProvider.registerViewModel(NumericTextBoxViewModel, undefined, NumericTextBoxModel, 'jqx-numeric-text-box');
