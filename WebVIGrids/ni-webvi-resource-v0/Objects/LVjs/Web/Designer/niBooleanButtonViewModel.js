...
export class BooleanButtonViewModel extends BooleanControlViewModel {
    bindToView() {
        super.bindToView();
        const that = this;
...
NIModelProvider.registerViewModel(BooleanButtonViewModel, undefined, BooleanButtonModel, 'jqx-toggle-button');
