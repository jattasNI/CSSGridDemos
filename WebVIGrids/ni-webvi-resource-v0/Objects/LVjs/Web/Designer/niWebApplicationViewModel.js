...
export class WebApplicationViewModel extends NIViewModel {
    // Constructor Function
    constructor(element, model) {
        super(element, model);
        if (this.model instanceof WebApplicationModel === false) {
            throw new Error(NI_SUPPORT.i18n('msg_INVALID_VI_MODEL'));
        }
        if (this.element instanceof WebApplication === false) {
